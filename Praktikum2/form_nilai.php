...
<body>
    ...
    <div class="form-group row">
        ...
        <select id="matkul" name="matkul" class="custom-select" required="required">
            <option value="Pemrograman Webbit">Pemrograman Web</option>
    ...
    <div class="form-group row">
        ...
        <div class="col-8">
        <input id="uts" name="uts" placeholder="Masukkan NIkai UTS" type="text" class="form-control" required="required">
        </div>
    </div>
    <div class="form-group row">
